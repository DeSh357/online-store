...
describe('product card', ()=> {
  ...
  beforeEach(() => {
    ...
    const authServiceSpy = jasmine.createSpyObj("AuthService", ["getIsLoggedIn"], {"isLogged$": of(true)});
  ...
  it('should have init value 1', ()=> {
    expect(productCardComponent.count).toBe(1);
  });

  it('should set value from input in countInCart to count', ()=> {
